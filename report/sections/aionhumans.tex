...
These technologies can also be used to influence people opinions. Huq et al. \cite{huq_ai-mediated_2025} tested this with AI-assisted messaging in an online chat platform. 557 Participants were randomly assigned to sessions of six to fifteen people, further subdivided into groups of two to four.
They discussed politically controversial topic selected to maximize opinion diversity within each three-minutes session, at the end of which they chose whether to remain in their current group, join another, or create a new one. 
...
Moreover, Noy et al. \cite{noy_experimental_2023} shows that people tend to send more messages when suggestions are available, but rarely edit them, suggesting partial delegation of expressive effort. 
